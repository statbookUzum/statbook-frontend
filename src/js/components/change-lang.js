...
export function changeLang(word) {
  const langObj = {
    ...
    'сум': 'so`m',
    'шт.': 'dona',
    'пароль не должен содержать кириллицы': 'Parolda kirill yozuvi bo`lmasligi kerak',
    ...
    'произошла ошибка, повторите запрос позже': 'Hatolik ro`y berdi. Iltimos keyinroq yana urinib ko`ring',
    ...
    'кажется что-то пошло не так, попробуйте позже': 'Nimadir xato ketdi shekilli, keyinroq qayta urinib ko‘ring',
