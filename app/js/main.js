...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_auth_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/auth-slider */ "./src/js/components/auth-slider.js");
/* harmony import */ var _components_auth_slider__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_auth_slider__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/loader */ "./src/js/components/loader.js");
...
/* harmony import */ var _components_nav_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/nav-menu */ "./src/js/components/nav-menu.js");
/* harmony import */ var _components_nav_menu__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_nav_menu__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_custom_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/custom-select */ "./src/js/components/custom-select.js");
...
/***/ "./src/js/components/auth-slider.js":
/*!******************************************!*\
  !*** ./src/js/components/auth-slider.js ***!
  \******************************************/
/***/ (() => {

var authButtons = document.querySelectorAll('.auth-form__bottom-btn');
var authBackButton = document.querySelector('.auth-form__back');
var authForms = document.querySelectorAll('form'); // forms
...
if (customInputs.length) {
  customInputs.forEach(function (label) {
    var input = label.querySelector('.custom-input__input'); // show password

    if (label.matches('.custom-input--password')) {
      var passwordBtn = label.querySelector('.custom-input__pass-btn');
    ...
    if (label.querySelector('.custom-input__clean')) {
      var cleanBtn = label.querySelector('.custom-input__clean');
...
(0,custom_select__WEBPACK_IMPORTED_MODULE_0__["default"])('#topUpSelect');
...
switchers.forEach(function (switcher) {
  var buttons = switcher.querySelectorAll('.switcher__button');
  var cover = switcher.querySelector('.switcher__cover');
  buttons.forEach(function (button, i) {
    button.addEventListener('click', function () {
      return animationSwitcher(button, i);
    });
...
var tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('profile-tabs'); // profile tabs animation
...
/***/ "./src/js/components/validation-form.js":
/*!**********************************************!*\
  !*** ./src/js/components/validation-form.js ***!
  \**********************************************/
/***/ (() => {
...
forms.forEach(function (form) {
  var inputs = form.querySelectorAll('.custom-input__input');
...
function inputValidate(label, index, error, onErrors, submitBtn, input, form) {
  ...
  if (label.matches('.custom-input--password')) {
    ...
    if (input.value.length < 6) {
      ...
      onErrors["".concat(index)] = true;
      disabledBtn(Object.values(onErrors), submitBtn);
      return;
    } // no cyrillic


    var cyrillicRegex = /[а-яА-Я]/;
    ...
    var newPassword = form.querySelector('[data-name=new-password]');
    var reapedPassword = form.querySelector('[data-name=reaped-password]');
